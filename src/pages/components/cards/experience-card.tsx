      ...
      <div className='relative grow'>
        ...
        <div className='absolute z-1 size-full p-4 flex flex-col gap-2'>
          ...
          <ul className='list-disc'>
            <li>Relevamiento y análisis de procesos genéricos (ej. gestión de usuarios, gestión de cambios a programa).</li>
            <li>Identificación de riesgos y controles de mitigación (ej. segregación de funciones, validación de cambios a programa, validación de <Link href='https://es.wikipedia.org/wiki/CRUD' className='underline' target='_blank'>ABM</Link> de usuarios).</li>
            <li>Revisión, análisis y documentación de la ejecución de controles.</li>
    ...
    <div className='w-full min-h-[20rem] flex flex hover:scale-[1.02] duration-100'>
      ...
      <div className='relative grow'>
        ...
        <div className='absolute z-1 size-full p-4 flex flex-col gap-2'>
          ...
          <ul className='list-disc'>
            <li>Introducción a las metodologías de EY para la participación en proyectos de auditoría</li>
            <li>Revisión, análisis y documentación de la ejecución de controles.</li>
          </ul>
        </div>
      </div>
    ...
    <div className='w-full min-h-[20rem] flex flex hover:scale-[1.02] duration-100'>
      ...
      <div className='relative grow'>
        ...
        <div className='absolute z-1 size-full p-4 flex flex-col gap-2'>
          ...
          <p className='w-full'>
            Mantenimiento e instalación de redes LAN, Ethernet y a internet en edificaciones con oficinas.
          </p>
        </div>
      </div>
    </div>
