...
export default function AboutMeCard() {
  return (
    <article className='size-full y-zinc-scrollbar'>
      <p className='w-full pb-2'>{about[0]}</p>
      <p className='w-full'>{about[1]}</p>
      <p className='w-full pb-2'>{about[2]}</p>
      <p className='w-full pb-2'>{about[3]}</p>
      <p className='w-full pb-2'>{about[4]}</p>
      <p className='w-full pb-2'>{about[5]}</p>
      <p className='w-full pb-2'>{about[6]}</p>
      ...
      <p className='w-full'>{about[9]}</p>
      <p className='w-full pb-2'>{about[10]}</p>
    </article>
  )
}
